from src.Fedmom2.FedAvg.client import FedAvgMom2Client
...
from src.FedMom1.FedAvg.client import FedAvgMom1Client

class FedProxMom1Client(FedAvgMom1Client):
    ...
    def fit(self, parameters, config):
        ...
        fedProxMom_train(self.model, self.train_loader, EPOCHS, config["proximal_mu"], global_params, optimizer=self.optimizer)
...
def get_fedprox_mom1_client_fn(dataset_loader: Callable) -> Callable:
    def fedprox_mom1_client_fn(context: Context) -> Client:
