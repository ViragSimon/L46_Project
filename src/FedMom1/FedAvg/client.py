...
class FedAvgMom1Client(FedPartAvgClient):
...
def get_fedavg_mom1_client_fn(dataset_loader: Callable) -> Callable:
    def fedavg_mom1_client_fn(context: Context) -> Client:
