...
class FedPseudoGradientSimilarityPartProxClient(FedPartProxClient):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

def get_fedpseudo_gradient_similarity_part_prox_client_fn(dataset_loader: Callable) -> Callable:
    def fedpseudo_gradient_similarity_part_prox_client_fn(context: Context) -> Client:
        ...
        return FedPseudoGradientSimilarityPartProxClient(
    ...
    return fedpseudo_gradient_similarity_part_prox_client_fn
