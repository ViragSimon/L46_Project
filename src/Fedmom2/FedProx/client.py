...
class FedProxMom2Client(FedAvgMom2Client):
...
def get_fedprox_mom2_client_fn(dataset_loader: Callable) -> Callable:
    def fedprox_mom2_client_fn(context: Context) -> Client:
